...
const Navbar = () => {
    return(
        <div className="w-screen h-16 bg-transparent justify-center flex flex-row">
            <div className="w-2/3 h-full flex flex-row gap-10 justify-start items-center border border-white">
                <div className="flex flex-row gap-0">
                    <Image width={70} height={35} src={logo} alt="Logo" />
                    <h1 className="text-3xl p-3 font-bold text-white">Clientelle</h1>
                </div>
                <div className="flex flex-row gap-8">
                    <Link href={"/"} className="text-gray-400 text-xl hover:text-white">Link1</Link>
                    <Link href={"/"} className="text-gray-400 text-xl hover:text-white">Link1</Link>
                </div>
